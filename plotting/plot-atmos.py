...
def help():
    print('plot-atmos.py -h     (help)')
    print('plot-atmos.py -p 3   (number of plots in one row)')
    sys.exit()
...
fig.savefig('atmosph.pdf', bbox_inches='tight', papertype='A0', dpi=600)
